...
public sealed class UpdateApplicationCommandValidatorTests
{
    ...
    public async Task Validate_WithValidCommand_IsValid()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "Name", "Desc", true,
            null, null, ["https://example.com/cb"], [], [], null, [], ["authorization_code", "refresh_token"], [], null, null, false, false);
    ...
    public async Task Validate_WithRedirectUris_IsValid()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "OAuth", "desc", true,
            null, null,
            ["https://example.com/callback"], [], [], "explicit", [], ["authorization_code", "refresh_token"], [], null, null, false, false);
    ...
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "OAuth", "desc", true,
            null, null, [], [], [], null, [], ["authorization_code", "refresh_token"], [], null, null, false, false);
    ...
    public async Task Validate_InvalidConsentType_HasError()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            null, null,
            ["https://example.com/cb"], [], [], "wrong", [], ["authorization_code", "refresh_token"], [], null, null, false, false);
    ...
    public async Task Validate_HttpRedirectUri_HasError()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            null, null,
            ["http://example.com/callback"], [], [], null, [], ["authorization_code", "refresh_token"], [], null, null, false, false);
    ...
    public async Task Validate_LocalhostHttpRedirectUri_IsValid()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            null, null,
            ["http://localhost:5000/callback"], [], [], null, [], ["authorization_code", "refresh_token"], [], null, null, false, false);
    ...
    public async Task Validate_WithValidAllowedOrigin_IsValid()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            ...
            ["authorization_code", "refresh_token"], [], null, null, false, false);
    ...
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            null, null, ["https://example.com/cb"], [], [], null, [], [], [], null, null, false, false);
    ...
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            null, null, ["https://example.com/cb"], [], [], null, [], ["invalid"], [], null, null, false, false);
    ...
    public async Task Validate_WithValidTokenLifetimes_IsValid()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            ...
            ["authorization_code", "refresh_token"], [], 30, 10080, false, false);
    ...
    public async Task Validate_WithAccessTokenLifetimeOutOfRange_HasError()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            null, null, ["https://example.com/cb"], [], [], null, [],
            ["authorization_code", "refresh_token"], [], 1441, null, false, false);
    ...
    public async Task Validate_WithRefreshTokenLifetimeOutOfRange_HasError()
    {
        var command = new UpdateApplicationCommand(Guid.NewGuid(), "App", "desc", true,
            null, null, ["https://example.com/cb"], [], [], null, [],
            ["authorization_code", "refresh_token"], [], null, 43201, false, false);
