...
{
    [HttpGet]
    [HasPermissionIn("system", "system", "system.identity-sources.view")]
    ...
    [HttpPost]
    [HasPermissionIn("system", "system", "system.identity-sources.create")]
    ...
    [HttpPut("{id:guid}")]
    [HasPermissionIn("system", "system", "system.identity-sources.update")]
    ...
    [HttpDelete("{id:guid}")]
    [HasPermissionIn("system", "system", "system.identity-sources.delete")]
