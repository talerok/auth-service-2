...
public static class AuthProblemDetailsMapper
{
    public static AuthProblemDescriptor Map(string code)
    {
        return code switch
        {
            ...
            AuthErrorCatalog.SystemPermissionImportForbidden => new AuthProblemDescriptor(StatusCodes.Status400BadRequest, "Business rule violation", "Cannot import over system permissions"),
            ...
            AuthErrorCatalog.ApplicationNotFound => new AuthProblemDescriptor(StatusCodes.Status404NotFound, "Resource not found", "Application not found"),
